...
export const Card: React.FC<TopRentedItemsCardsProps> = ({
  ...
  return (
    <Link
      href={`#`}
      target="_blank"
      className="min-w-[285px] h-[370px] rounded-[20px] bg-[#8D8BD3]/20 flex flex-col gap-[7px] transition-transform duration-300 ease-in-out transform hover:scale-105 hover:bg-gradient-to-r hover:from-purple-500 hover:to-blue-500" // Hover zoom effect with transition and gradient
    ...
    >
      ...
      <div className="text-white mx-[20px]">
        ...
        <div className="font-outfit font-semibold text-[22px]">
            {itemName}
          </div>
        <div className="flex flex-row gap-6 text-center mt-2">
        <div className="flex flex-row gap-[2px] items-baseline text-[#C4E1F6] ">
         
        <div>
            <UserRound className="size-[18px] " />
          </div>
          <div className="font-outfit font-semibold text-[18px] ">
            {lender}
          </div>
          </div>
          <div className="flex flex-row gap-[1px] items-center text-[#FFE3E3]">
            <div>
              <MapPin className="size-[20px]" />
            </div>
            <div className="font-outfit font-medium text-[16px] ]">
              {place}
            </div>
          </div>
        </div>
        <div className="flex flex-row justify-between items-center">
          <div>
            ...
            -{" "}
            <span className="font-outfit font-medium text-green-500 text-[20px]">
              ₹{currentPrice}
            </span>{" "}
