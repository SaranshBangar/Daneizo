    ...
    <section>
      <div className="flex flex-col justify-center items-start gap-3">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full">
          <div className="h-fit rounded-[20px] bg-gradient-to-br from-[#8D8BD3]/20 to-[#433FD7]/20 py-[36px] pl-[37px] pr-[43px] flex flex-row justify-between w-full md:w-[85%]">
            <div>
          ...
          <a
            href="/"
            className="mt-4 md:mt-0 cursor-pointer underline underline-offset-4 text-[#D9D9D9] font-outfit font-medium text-[20px]"
          >
            Similar sellers...
          </a>
        </div>
